package com.evernym.agent.core.platform.transport
...
class CoreAgentTransportPlatform(val commonParam: CommonParam, val routeParam: TransportHttpAkkaRouteParam)
  ...
  override def stop(): Unit = {
    println("TODO: core-agent-transport-platform stopped")
  }
}