package com.evernym.agent.core.protocol.business
...
class CoreAgentBusinessProtocol(val commonParam: CommonParam) extends BusinessProtocol with ActorRefResolver {
